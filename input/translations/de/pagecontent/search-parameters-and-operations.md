...
Modul-spezifische FHIR-Suchparameter und Operationen des Moduls **Dokument**, sofern vorhanden.

Die folgenden Suchparameter MÜSSEN für das Profil [MII PR Dokument Dokument](StructureDefinition-mii-pr-dokument-dokument.html) unterstützt werden, auch in Kombination:
...
Das Profil selbst ist auf [Profile und Erweiterungen](profiles-and-extensions.html) dokumentiert. Das Modul definiert keine eigenen Operationen. <!-- TODO:REVIEW (Gate B): Abschnitt von der Profilseite der Quelle hierher verschoben (Template-Seitenraster) -->
