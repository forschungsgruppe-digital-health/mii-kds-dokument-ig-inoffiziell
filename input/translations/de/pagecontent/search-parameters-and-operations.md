...
<!-- MIGRATED CONTENT — provenance:
     implementation-guides/mii-ig-dokument-de/MIIIGModulDokument/TechnischeImplementierung/FHIRProfile/Dokument-DocumentReference.page.md (Abschnitt „Suchparameter“)
...
Die Suchparameter dieses Moduls werden im MII KDS-Modul Meta definiert und hier für das
Profil [mii-pr-dokument-dokument](StructureDefinition-mii-pr-dokument-dokument.html)
zusammengefasst. Die Profilbeschreibung steht auf
[Profile und Extensions](profiles-and-extensions.html#dokument-documentreference).
