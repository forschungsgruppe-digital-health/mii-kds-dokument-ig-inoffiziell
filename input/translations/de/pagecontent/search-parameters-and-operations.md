...
<!--
  Suchparameter und Operationen — DEUTSCHE Fassung (maßgeblich). Quelle:
  ...
  Abschnitt "Suchparameter" (dort wortgetreu übernommen). Englische Fassung:
  input/pagecontent/search-parameters-and-operations.md (maschinelle
  Übersetzung, Review an Gate C).
-->
### Suchparameter und Operationen

Die hier aufgeführten Suchparameter gelten für das Profil
[MII PR Dokument Dokument](StructureDefinition-mii-pr-dokument-dokument.html)
des Moduls **Dokument** — siehe
