...
Das folgende Paketabhängigkeitsdiagramm zeigt die Bezüge des MII KDS-Moduls
Dokument zu den weiteren Paketen; die Zusammenhänge zwischen den MII Modulen
...
<!-- TODO:REVIEW: Die Simplifier-Quelle (Referenzen.page.md) verlinkte an dieser
     ...
     (Produktions-Repository); ersetzt durch das lokale PNG aus input/images/. -->
