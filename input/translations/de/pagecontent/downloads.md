...
<!-- Quelle: implementation-guides/mii-ig-dokument-de/MIIIGModulDokument/Referenzen.page.md.
     TODO:REVIEW Das Bild ersetzt den externen Link der Quelle auf
...
![Paketabhängigkeitsdiagramm des MII KDS-Moduls Dokument](Paketabhaengigkeiten.png)

Wichtig ist zu beachten, dass eine Kompatibilität aus der klinischen Routine zu der Referenz Dokument gewährleistet werden kann, aber keine Rückwärtskompatibilität in die Routine vorgesehen ist. Im Paketabhängigkeitsdiagramm (oben) sind die Zusammenhänge zwischen den MII Modulen grün dargestellt.
