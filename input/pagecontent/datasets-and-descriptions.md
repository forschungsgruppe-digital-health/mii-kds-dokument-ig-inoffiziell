...
<!-- TODO:REVIEW - MACHINE TRANSLATION.
     ...
     input/translations/de/pagecontent/datasets-and-descriptions.md, which carries the module's ORIGINAL German
...
The officially adopted version of the information model is on
...
To unify the representation, the information model is additionally expressed as a FHIR logical
model.
...
profiles. For every element of the logical model there is a 1:1 mapping onto an element of a
concrete FHIR resource.*

The structural rendering of the logical model is on [Logical Models](logical-models.html).
...
<!-- GENERATED TABLE — mechanically extracted from
     ...
     The descriptions are the PUBLISHED German element definitions and are NOT translated —
     translating a normative element definition would change it.
     REGENERATE after any change to input/fsh/logical-model/. -->

> The element descriptions below are the published German definitions of the logical model and
> are reproduced verbatim; they are normative and the migration does not translate them.

| Logical dataset element | Description (German, as published) | FHIR element |
| --- | --- | --- |
