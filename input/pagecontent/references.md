...
Dabei wurde ein Abgleich aller Datenelemente sowie der verwendeten Terminologie durchgeführt und im Dokument-Profil ([Dokument: DocumentReference](StructureDefinition-mii-pr-dokument-dokument.html)) abgebildet. Die Kardinalitäten sind offen gestaltet, sodass in dieser Hinsicht keine (weiteren oder neuen) Einschränkungen eingeführt wurden. Die in den abgeglichenen Profilen verwendete Terminologie wurde im Dokument-Profil ([Dokument: DocumentReference](StructureDefinition-mii-pr-dokument-dokument.html)) einbezogen und abgebildet.
