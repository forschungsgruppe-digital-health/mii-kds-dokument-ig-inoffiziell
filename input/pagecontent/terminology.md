...
CodeSystem: [MII CS Dokument NLP Processing Status](CodeSystem-mii-cs-dokument-nlp-processing-status.html)
...
ValueSet: [MII VS Dokument SCT Dokument Typ](ValueSet-mii-vs-dokument-sct-dokument-typ.html)
...
ValueSet: [MII VS Dokument SCT Dokument Kategorie](ValueSet-mii-vs-dokument-sct-dokument-kategorie.html)
...
ValueSet: [MII VS Dokument Format Code](ValueSet-mii-vs-dokument-format-code.html)
...
ValueSet: [MII VS Dokument Einrichtungsart](ValueSet-mii-vs-dokument-einrichtungsart.html)
...
ValueSet: [MII VS Dokument Fachgebiet](ValueSet-mii-vs-dokument-fachgebiet.html)
