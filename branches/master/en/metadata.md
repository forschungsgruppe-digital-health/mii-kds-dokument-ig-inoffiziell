...
The following CRMI-related metadata is set in [`sushi-config.yaml`](https://github.com/forschungsgruppe-digital-health/mii-kds-dokument-ig-inoffiziell/blob/main/sushi-config.yaml) and ends up in the generated `ImplementationGuide` resource.
...
| [Resource Approval Date](http://hl7.org/fhir/extensions/5.3.0/StructureDefinition-resource-approvalDate.html) | Artifact lifecycle; publishing; governance | `ImplementationGuide.extension`(`2026-08-02`) | Records the date on which the publisher officially approved the content for use. |
