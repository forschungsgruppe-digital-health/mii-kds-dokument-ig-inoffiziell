...
Diese Seite legt fest, wie ein konformes System solche Fälle in den Ressourcen des Moduls **Dokument** darstellt. Die Regeln stimmen mit der [FHIR-Kernspezifikation](https://hl7.org/fhir/R4/extensibility.html#Special-Case) überein und sind konsistent mit der internationalen Praxis, wie sie die [International Patient Summary (IPS)](https://hl7.org/fhir/uv/ips/Empty-Sections-and-Missing-Data.html) definiert.
