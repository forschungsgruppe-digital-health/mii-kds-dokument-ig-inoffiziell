...
[![Paketabhaengigkeiten](Paketabhaengigkeiten.png) ](https://github.com/medizininformatik-initiative/kerndatensatz-dokument/raw/refs/heads/dev/input/plantuml/Paketabhaengigkeiten.svg)
...
Dabei wurde ein Abgleich aller Datenelemente sowie der verwendeten Terminologie durchgeführt und im Dokument-Profil ([Dokument DocumentReference](profiles-and-extensions.md#dokument-documentreference)) abgebildet. Die Kardinalitäten sind offen gestaltet, sodass in dieser Hinsicht keine (weiteren oder neuen) Einschränkungen eingeführt wurden. Die in den abgeglichenen Profilen verwendete Terminologie wurde im Dokument-Profil ([Dokument DocumentReference](profiles-and-extensions.md#dokument-documentreference)) einbezogen und abgebildet.
