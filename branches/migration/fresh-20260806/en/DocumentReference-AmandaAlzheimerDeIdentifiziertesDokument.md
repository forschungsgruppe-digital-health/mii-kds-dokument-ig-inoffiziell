...
**MII EX Dokument NLP Processing Status**: De-identified document
...
| :--- | :--- | :--- |
| - | **Code** | **Target** |
| * | Transforms | [DocumentReference: extension = Original document; masterIdentifier = OID:1.2.840.113556.1.8000.2554.58783.21864.3474.19410.44358.58254.41281.46340; identifier = UUID:0c287d32-01e3-4d87-9953-9fcc9404eb21 (use: official, ); status = current; docStatus = final; type = Ärztlicher Verlaufsbericht; category = Brief; securityLabel = normal](DocumentReference-AmandaAlzheimerOriginalDokument.md) |
...
| * | text/plain | German (Austria) | (base64 data - 8,984 base64 chars) | 6736 | `PO6tZryRCRFyjrsMcKnCFuqxX1s=` | De-ID.txt |
